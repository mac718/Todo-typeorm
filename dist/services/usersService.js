...
function SignUp(name, email, password) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, userRepository_1.UserRepository.findOneBy({ email: email })];
                case 1:
                ...
                case 2:
                    ...
                    newUser.token = "";
                    newUser.tasks = [];
                    return [4 /*yield*/, userRepository_1.UserRepository.create(newUser)];
                case 3:
                    createdUser = _a.sent();
                    token = jsonwebtoken_1.default.sign({ user_id: createdUser.id, email: createdUser.email }, "supersecretjwtsecret", { expiresIn: "2h" });
                    newUser.token = token;
                    return [4 /*yield*/, userRepository_1.UserRepository.save(createdUser)];
                case 4:
                    _a.sent();
